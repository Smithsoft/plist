...
class Admin extends React.Component<RouteComponentProps, StateType> {
    state = {
        role: '',
        name: '',
        email: '',
    ...
    componentDidMount(): void {
        ...
        if (login && token) {
            ...
            console.log('ADMIN PROFILE UPDATE ISSUE - token or user missing')
    ...
    loadProfile(user: User, token: string): void {
        ...
        axios
            ...
            .catch((error: AxiosError<ErrorResponse>) => {
                ...
                console.log('ADMIN PROFILE UPDATE ERROR: ', serverError)
    ...
    clickSubmit(event: React.MouseEvent<HTMLButtonElement>): void {
        ...
        const url = `${process.env.REACT_APP_API}/admin/update`
